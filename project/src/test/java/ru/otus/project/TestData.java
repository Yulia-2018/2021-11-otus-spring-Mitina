...
public class TestData {
    ...
    public static final Long TASK_NEW_ID_FOR_ADMIN = 100009L;
    ...
    public static final Task TASK_NEW_FOR_ADMIN = new Task(TASK_NEW_ID_FOR_ADMIN, "New task", LocalDate.of(2022, 7, 18), false, ADMIN);
